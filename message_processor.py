...
class MessageProcessor:
    ...
    def extract_reminder_info(self, message: str) -> Optional[Dict]:
        ...
        try:
            ...
            1. Текст напоминания (что нужно напомнить). Важно, чтобы ты писал напоминание с большой буквы, а также описывал именно суть действия, не просто слова "напомнить что-тот там в конкретное время". Например, "Напомни мне зарегистрироваться на марафон завтра": суть напоминания это "Зарегистрироваться на марафон"
