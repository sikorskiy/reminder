...
class MessageProcessor:
    ...
    def extract_reminder_info(self, message: str) -> Optional[Dict]:
        ...
        try:
            ...
            4. Если в сообщении НЕТ четкой информации о времени (например, "напомни про что-то" без указания когда), то установи время через 1 час от текущего времени.
            ...
            - "напомни про встречу" = текущее время + 1 час (по умолчанию)
